...
async function createconfig() {
  ...
  const config = {
    ...
    baseUrl: "/solution-ThirdPartyRisk-wxai",


    // GitHub pages deployment config.
    // If you aren"t using GitHub pages, you don"t need these.
    organizationName: "ibm-client-engineering", // Usually your GitHub org/user name.
    projectName: "solution-ThirdPartyRisk-wxai", // Usually your repo name.
        ...
        ({
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              "https://github.com/ibm-client-engineering/solution-ThirdPartyRisk-wxai/edit/main/${blogDirPath}/${blogPath}",
    ...
    themeConfig:
      ...
      ({
        ...
        navbar: {
          title: "| Third Party Risk with watsonx.ai",
          logo: {
          ...
          items: [
            ...
            {
              href: "https://github.com/ibm-client-engineering/solution-ThirdPartyRisk-wxai",
