...
---
# Third Party Risk with watson<span style={{ color: '#3a60f6' }}>x</span>.ai

**Contacts:**  Eashan Thakuria, John Scott <br />
**Team:** FSM CE East <br />

This is a living document for an adoption journey that synthesizes the best practices from IBM when considering and implementing **Third Party Risk with watson<span style={{ color: '#3a60f6' }}>x</span>.ai**
