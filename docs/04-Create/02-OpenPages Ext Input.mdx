...
## Overview
------
There are three core steps to build the components necessary to achieve the desired outcomes of the business case: 

1. Create OpenPages File Directory

1. **Build OpenPages Library**
    1. Create Assessment Template
    2. Create Mandate and its MSR requirements

2. **Configure OpenPages Vendor Management**
    1. Create Business Entity and Vendor
    2. Create Vendor SIG Assessment

3. **Deploy and integrate watson<span style={{ color: '#3a60f6' }}>x</span>.ai functions**
...
#### Import Content via FastMap


### Create Mandate

#### Create relevant objects for Mandate
...
----
### Create relevant objects for new Vendor SIG
1. Create Business Entity Object

2. Create Vendor Object
